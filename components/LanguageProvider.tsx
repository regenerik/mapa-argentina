...
const spanish = {
  ...
  rotateInterface: "Girar interfaz 90 grados",
  restoreRotation: "Restaurar orientacion",
  rotateInterfaceShort: "Girar",
  restoreRotationShort: "Normal",
  logoutEditing: "Salir",
  logoutEditingAria: "Cerrar sesión de edición y volver al inicio",
  ...
  imageRotation: "Rotación de imagen",
  rotateImageLeft: "Girar imagen 90 grados a la izquierda",
  rotateImageRight: "Girar imagen 90 grados a la derecha",
  ...
  remove: "Quitar",
  view: "Vista",
  editImagePreview: "Editar imagen",
  editImagePreviewCopy: "Ajustá el área visible que se mostrará en la ficha del punto.",
  previewViewport: "Vista de previsualización",
  desktopPreview: "Desktop",
  mobilePreview: "Móvil",
  adjustVisibleArea: "Ajustá el área visible",
  adjustVisibleAreaCopy: "Arrastrá la imagen para encuadrar. Usá el zoom para acercar o alejar.",
  zoom: "Zoom",
  resetCrop: "Restablecer",
  preview: "Vista previa",
  desktopPreviewCopy: "Así se verá la imagen en la ficha pública de escritorio.",
  mobilePreviewCopy: "Así se verá la imagen en la ficha pública móvil.",
  previewCropNote: "La imagen se mostrará con este encuadre en la ficha del punto.",
  editImagePreviewSample: "Previsualización del encuadre antes de guardar.",
  ...
  usageDisclaimer: "Las imágenes son de carácter ilustrativo y muestran resultados obtenidos en condiciones específicas. No constituyen una recomendación de aplicación. Para más información y recomendaciones de uso, consultá al equipo técnico de Sumitomo Chemical.",
  required: "Obligatorio",
  noTargetWeeds: "No hay malezas cargadas en el catalogo de Google Sheets.",
  noLocalities: "No hay localidades cargadas todavia.",
  province: "Provincia",
  ...
  filterByWeed: "Maleza Target:",
  filterByProvince: "Provincias:",
  filterByLocality: "Localidades:",
  all: "Todas",
  selectAll: "Seleccionar todas",
  clearFilter: "Desmarcar todo",
...
const english: AppCopy = {
  ...
  rotateInterface: "Rotate interface 90 degrees",
  restoreRotation: "Restore orientation",
  rotateInterfaceShort: "Rotate",
  restoreRotationShort: "Normal",
  logoutEditing: "Exit",
  logoutEditingAria: "Log out of editing and return home",
  ...
  rotateImageLeft: "Rotate image 90 degrees left",
  rotateImageRight: "Rotate image 90 degrees right",
  rotateLeft: "Left",
  rotateRight: "Right",
  ...
  remove: "Remove",
  view: "View",
  editImagePreview: "Edit image",
  editImagePreviewCopy: "Adjust the visible area shown in the point card.",
  previewViewport: "Preview viewport",
  desktopPreview: "Desktop",
  mobilePreview: "Mobile",
  adjustVisibleArea: "Adjust visible area",
  adjustVisibleAreaCopy: "Drag the image to frame it. Use zoom to move closer or farther away.",
  zoom: "Zoom",
  resetCrop: "Reset",
  preview: "Preview",
  desktopPreviewCopy: "This is how the image will appear in the public desktop card.",
  mobilePreviewCopy: "This is how the image will appear in the public mobile card.",
  previewCropNote: "The image will use this framing in the point card.",
  editImagePreviewSample: "Preview the framing before saving.",
  saveCrop: "Save crop",
  ...
  usageDisclaimer: "Images are illustrative and show results obtained under specific conditions. They do not constitute an application recommendation. For more information and use recommendations, consult the Sumitomo Chemical technical team.",
  required: "Required",
  noTargetWeeds: "No weeds are loaded in the Google Sheets catalog.",
  noLocalities: "No localities have been loaded yet.",
  province: "Province",
  ...
  filterByWeed: "Target Weed:",
  filterByProvince: "Provinces:",
  filterByLocality: "Localities:",
  all: "All",
  selectAll: "Select all",
  clearFilter: "Unselect all",
