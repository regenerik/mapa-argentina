...
export function MapControls() {
  ...
  return (
    <div className="map-controls" aria-label="Controles del mapa">
      <HoldZoomButton action={zoomIn} label="Acercar">+</HoldZoomButton>
      <HoldZoomButton action={zoomOut} label="Alejar">−</HoldZoomButton>
      <button className="reset-control" type="button" onClick={() => resetTransform()} aria-label="Restablecer vista">
